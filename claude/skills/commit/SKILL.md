---
name: commit
description: Create a focused Git commit from the intended working-tree changes, following repository conventions. Use when the user or an approved plan asks Claude Code to commit completed work.
---
...
Pass the message via a heredoc and always append a `Co-Authored-By: Claude Fable 5 <noreply@anthropic.com>` trailer:
