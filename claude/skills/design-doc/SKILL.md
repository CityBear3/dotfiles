...
After all material decisions are settled, Claude Code may draft the complete
Design Doc. Derive its design-specific prose from the decision record and
...
- Date: YYYY-MM-DD
- Status: Draft
- Extends: (list prior Design Docs this extends, if any)
...
Review every draft, whether authored by Claude Code or by the user. Check:
