...
Ground claims in the plan and current files. Label any additional interpretation as `補足(Claude の解説)`. Do not invent rationale that the plan does not record.
