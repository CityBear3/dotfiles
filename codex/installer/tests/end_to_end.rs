...
fn workflow_bundle_replaces_owned_roles_and_preserves_unmanaged_assets() {
    ...
    let expected_bindings = [
        ...
        ("focused-reviewer", "gpt-6-sol", "high", "read-only"),
        ("spec-reviewer", "gpt-6-sol", "high", "read-only"),
        (
        ...
        ("risk-reviewer", "gpt-6-sol", "xhigh", "read-only"),
        ("finding-integrator", "gpt-6-sol", "high", "read-only"),
        (
